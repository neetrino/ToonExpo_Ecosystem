...
export class PortalVisualMapController {
  ...
  listByProject(
    ...
    return this.visualMapService.listByProject(member, projectId);
  }
  ...
  create(
    ...
    return this.visualMapService.create(member, user.id, projectId, body);
  }
  ...
  getById(
    ...
    return this.visualMapService.getById(member, id);
  }
  ...
  update(
    ...
    return this.visualMapService.update(member, user.id, id, body);
  }
  ...
  async remove(
    ...
    await this.visualMapService.remove(member, id);
  }
  ...
  createHotspot(
    ...
    return this.visualMapService.createHotspot(member, user.id, canvasId, body);
  }
  ...
  async removeHotspot(
    ...
    await this.visualMapService.removeHotspot(member, canvasId, hotspotId);
  }
}
