...
export class PortalApartmentsController {
  ...
  list(
    ...
    return this.apartmentsService.listByFloor(member, floorId);
  }
  ...
  create(
    ...
    return this.apartmentsService.create(member, user.id, floorId, body);
  }
  ...
  createBulk(
    ...
    return this.apartmentsService.createBulk(member, user.id, floorId, body);
  }
  ...
  getById(
    ...
    return this.apartmentsService.getById(member, apartmentId);
  }
  ...
  update(
    ...
    return this.apartmentsService.update(member, user.id, apartmentId, body);
  }
  ...
  updatePublication(
    ...
    return this.apartmentsService.updatePublication(
      member,
      user.id,
      apartmentId,
      body,
  ...
  async remove(
    ...
    await this.apartmentsService.remove(member, apartmentId);
  }
}
