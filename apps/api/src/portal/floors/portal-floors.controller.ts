...
export class PortalFloorsController {
  ...
  list(
    ...
    return this.floorsService.list(member, buildingId);
  }
  ...
  create(
    ...
    return this.floorsService.create(member, user.id, buildingId, body);
  }
  ...
  update(
    ...
    return this.floorsService.update(member, user.id, floorId, body);
  }
  ...
  updatePublication(
    ...
    return this.floorsService.updatePublication(member, user.id, floorId, body);
  }
  ...
  async remove(
    ...
    await this.floorsService.remove(member, floorId);
  }
}
