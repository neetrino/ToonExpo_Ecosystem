...
export class PortalProjectsController {
  ...
  list(
    ...
    return this.projectsService.list(member.companyId, query.page, query.pageSize);
  }
  ...
  create(
    ...
    return this.projectsService.create(member.companyId, user.id, body);
  }
  ...
  getQr(
    ...
    return this.projectQrService.getProjectQr(member.companyId, projectId);
  }
  ...
  getById(
    ...
    return this.projectsService.getById(member.companyId, projectId);
  }
  ...
  update(
    ...
    return this.projectsService.update(member.companyId, user.id, projectId, body);
  }
  ...
  async remove(
    ...
    assertCompanyAdmin(member);
    await this.projectsService.remove(member.companyId, projectId);
  }
}
