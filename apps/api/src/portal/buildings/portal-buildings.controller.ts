...
export class PortalBuildingsController {
  ...
  list(
    ...
    return this.buildingsService.list(member, projectId);
  }
  ...
  create(
    ...
    return this.buildingsService.create(member, user.id, projectId, body);
  }
  ...
  getById(
    ...
    return this.buildingsService.getById(member, buildingId);
  }
  ...
  update(
    ...
    return this.buildingsService.update(member, user.id, buildingId, body);
  }
  ...
  updatePublication(
    ...
    return this.buildingsService.updatePublication(
      member,
      user.id,
      buildingId,
      body,
  ...
  async remove(
    ...
    await this.buildingsService.remove(member, buildingId);
  }
}
