...
@Module({
  ...
  providers: [CompanyMembersService, CompanyProfileService, CompanyAdminGuard, CompanyMemberGuard],
  exports: [CompanyAdminGuard, CompanyMemberGuard, CompanyProfileService],
})
