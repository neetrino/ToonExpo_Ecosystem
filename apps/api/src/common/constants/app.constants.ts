...
export const DEFAULT_GLOBAL_RATE_LIMIT = AUTH_RATE_LIMIT_LIMIT * GLOBAL_RATE_LIMIT_AUTH_MULTIPLIER;
...
export const FORGOT_PASSWORD_RESPONSE_MESSAGE = 'If the email exists, a link has been sent';
