...
export const generateMetadata = async ({
  ...
  return {
    ...
    description:
      ...
      t("partnersPage.metaFallback", { name: partner.name }),
  };
};
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="mx-auto grid w-full max-w-content gap-10 px-6 py-10 lg:grid-cols-[2fr_1fr]">
            ...
            <div className="rounded-sm border border-border bg-surface p-4">
              ...
              {partner.socialLinks ? (
                <ul className="mt-4 flex flex-col gap-2 text-sm">
                  {Object.entries(partner.socialLinks).map(([key, url]) => (
                    <li key={key}>
                      <a
                        href={url}
