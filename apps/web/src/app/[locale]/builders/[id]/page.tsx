    ...
    <div className="min-h-screen bg-background">
      <main className="mx-auto w-full max-w-content px-6 py-10">
        <div className="mb-8 flex flex-col gap-4">
          <Link href="/builders" className="text-sm text-ink-secondary hover:text-ink">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-3xl font-bold tracking-tight text-ink">{builder.name}</h1>
              {builder.description ? (
        ...
        {builder.projects.length === 0 ? (
          <p className="text-sm text-ink-secondary">{t('buildersPage.detail.emptyProjects')}</p>
        ) : (
