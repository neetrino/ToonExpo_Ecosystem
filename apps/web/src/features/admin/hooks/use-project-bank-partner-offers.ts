...
} from '@/features/admin/api/project-bank-partner-offers-api';
...
/** Published templates available for multi-import into project Finance. */
export const useSelectableTemplatesQuery = (scope: CatalogScope) =>
  useQuery({
    queryKey: selectableTemplatesQueryKey(scope),
    queryFn: () => listSelectableTemplates(scope, { publishedOnly: true }),
  });
