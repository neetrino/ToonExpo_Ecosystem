...
import { Building2, Landmark, LayoutDashboard, Settings, Tag } from 'lucide-react';
...
type NavItem = {
  href: '/partner' | '/partner/offers' | '/partner/bank-offers' | '/partner/settings';
  key: 'profile' | 'offers' | 'bankOffers' | 'settings';
  icon: LucideIcon;
};
