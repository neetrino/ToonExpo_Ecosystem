...
export { InteractiveMappingScopeRoot } from './components/interactive-mapping-scope-root';
...
export { BuildingsPhasePage } from './components/pages/buildings-phase-page';
