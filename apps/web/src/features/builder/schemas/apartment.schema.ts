...
export const updateApartmentSchema = z.object({
  ...
  finishingStatusHy: z.string().trim().max(PORTAL_DESCRIPTION_MAX_LENGTH),
  finishingStatusRu: z.string().trim().max(PORTAL_DESCRIPTION_MAX_LENGTH),
  finishingStatusEn: z.string().trim().max(PORTAL_DESCRIPTION_MAX_LENGTH),
  handoverDescriptionHy: z.string().trim().max(PORTAL_DESCRIPTION_MAX_LENGTH),
  handoverDescriptionRu: z.string().trim().max(PORTAL_DESCRIPTION_MAX_LENGTH),
  handoverDescriptionEn: z.string().trim().max(PORTAL_DESCRIPTION_MAX_LENGTH),
