...
/**
 * MaMarie-style mobile builder hub: avatar + destinations as page body.
 * Sub-pages slide over this hub via BuilderMobileStack.
 */
export const BuilderMobileHub = ({
  name,
  email,
  companyName,
  className,
}: BuilderMobileHubProps) => {
      ...
      <section className={cn(CARD_CLASS, 'px-4 py-4')} aria-label={t('label')}>
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="truncate text-sm leading-snug text-ink-muted">{companyName ?? email}</p>
          </div>
        </div>
      </section>
