/** Shared control styles for luxury auth forms (height-aware for short viewports). */
export const AUTH_CONTROL_CLASS =
  'h-11 rounded-md border-border/55 bg-[#faf9f6] shadow-[inset_0_1px_0_rgb(255_255_255_/_0.65)] ' +
...
export const AUTH_SUBMIT_CLASS =
  'mt-1 h-11 w-full rounded-md tracking-[0.04em] shadow-md ' +
  'transition-[transform,box-shadow,background-color] duration-[var(--duration-base)] ' +
  'hover:shadow-lg min-[900px]:mt-2 min-[900px]:h-12';
