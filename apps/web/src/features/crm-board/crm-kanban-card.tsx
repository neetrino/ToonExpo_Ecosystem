      ...
      >
        ...
        >
          <div className="flex flex-wrap items-start gap-1.5">
            <span className="min-w-0 flex-1 break-words text-[13px] font-semibold tracking-tight text-brand-deep">
              {buyerLabel}
            </span>
            <span
              className={cn(
                'shrink-0 whitespace-normal rounded-pill px-1.5 py-0.5 text-[9px] font-semibold uppercase tracking-[0.06em]',
