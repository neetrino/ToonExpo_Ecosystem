export { CRM_KANBAN_STATUSES, type CrmBoardMode } from '@/features/crm-board/constants';
export { CrmKanbanBoard } from '@/features/crm-board/crm-kanban-board';
export { CrmDealSheet } from '@/features/crm-board/crm-deal-sheet';
