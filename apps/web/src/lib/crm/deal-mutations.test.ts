...
describe('updateDealStage', () => {
  ...
  it('sets apartments RESERVED and writes STATUS_CHANGE when moving to RESERVED', async () => {
  ...
  it('sets apartments SOLD when moving to CONVERTED', async () => {
