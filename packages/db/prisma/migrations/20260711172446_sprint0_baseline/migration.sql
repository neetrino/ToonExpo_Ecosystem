...
CREATE TABLE "User" (
    ...
    "phone" TEXT,
    "passwordHash" TEXT,
    "role" "PlatformRole" NOT NULL DEFAULT 'BUYER',
...
-- CreateIndex
CREATE UNIQUE INDEX "QrCode_buyerProfileId_key" ON "QrCode"("buyerProfileId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Apartment_floorId_code_key" ON "Apartment"("floorId", "code");
...
-- AddForeignKey
ALTER TABLE "QrCode" ADD CONSTRAINT "QrCode_buyerProfileId_fkey" FOREIGN KEY ("buyerProfileId") REFERENCES "BuyerProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
