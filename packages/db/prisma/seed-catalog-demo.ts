...
export const CATALOG_DEMO_DETAILS: Record<string, CatalogLocaleText | string> = {
  ...
  designer: 'Myler Mountain Resort',
  contractor: 'The Builders',
  ...
  parkingPrice: t('7 000 000 ՀՀ դրամ', '7 000 000 драмов РА', 'AMD 7,000,000'),
  services: t(
  ...
  elevatorsCount: '2',
  specialTermsAvailable: t('առկա է', 'есть', 'Available'),
  specialTerms: t(
  ...
  incomeTaxRefund: t('այո', 'да', 'Yes'),
  constructionType: t('մոնոլիտ', 'монолит', 'Monolithic'),
  facadeMaterials: t('Փայտ, վայրի քար', 'Дерево, дикий камень', 'Wood, natural stone'),
  thermalSoundInsulation: t('Ըստ ստանդարտների', 'По стандартам', 'Per standards'),
  totalLandArea: t('տվյալներ չկան', 'нет данных', 'N/A'),
  totalResidentialArea: t('տվյալներ չկան', 'нет данных', 'N/A'),
  apartmentsCount: '309',
  availableApartmentsCount: '142',
  parkingSpaces: '45',
  openParkingSpaces: '25',
  closedParkingSpaces: '20',
  parkingStandardSizes: t('18 ք/մ', '18 м²', '18 m²'),
  ceilingHeightM: '3.00',
  floorsCount: '6',
  heating: t('Կենտրոնական', 'Центральное', 'Central'),
  cooling: t('Կենտրոնական', 'Центральное', 'Central'),
  hotWater: t('Կենտրոնական', 'Центральная', 'Central'),
  gas: t('այո', 'да', 'Yes'),
  commercialAreaSqm: t('այո', 'да', 'Yes'),
  subsidizedPrograms: t(
    'Ազատ տնտեսական գոտի',
