import type { ApartmentStatus, PriceVisibility, PrismaClient } from '@prisma/client';
...
export const CATALOG_PROJECT_SEEDS: readonly CatalogProjectSeed[] = [
  {
    ...
    description: 'Premium apartments near the Cascade with Ararat views and underground parking.',
    city: 'Yerevan',
...
async function upsertCatalogCompany(prisma: PrismaClient, seed: CompanySeed): Promise<string> {
