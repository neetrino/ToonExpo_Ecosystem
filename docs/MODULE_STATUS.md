...
Краткий обзор готовности продуктовых модулей по состоянию кода. Обновлено: **2026-07-18** (wave 4 — docs sync).
...
| **13 Admin / Content Management** | 🟡 Частично | Admin: companies, partners, readiness, bank offers, service providers, events/exhibition, analytics (incl. favorites aggregates), BOS provisioning read views | 📋 Homepage CMS; 📋 global audit log; 📋 cross-company catalog editing |
...
- Admin cross-company catalog/inventory editing.
- Public service-provider directory page.
