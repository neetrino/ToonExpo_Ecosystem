...
| Public Exhibition Map            | View snapshot status/history |                   View public |                   View public |                View public |          View public |
| Check-in (later separate module) |                 View summary |                            No |                            No |                    Show QR |        Scan/check-in |
| Analytics                        |                         Full |              Own company data |           Own data if enabled |                         No | Future check-in only |
