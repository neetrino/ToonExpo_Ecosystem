# ToonExpo Ecosystem Documentation Hub

## Purpose

This documentation belongs to the ToonExpo Ecosystem repository.

It contains only ToonExpo documentation plus a small integration contract with BigProjects BOS.
...
- [Project — Status](./PROJECT-STATUS.md) — module-by-module readiness (%)
...
- [Implementation Roadmap](./00-Implementation-Roadmap.md)
...
- [Account & Access](./02-ToonExpo-Ecosystem/01-Modules/01-Account-Access.md)
- [Public Web / Mobile App](./02-ToonExpo-Ecosystem/01-Modules/02-Public-Web-Mobile-App.md)
- [Buyer / Visitor Area](./02-ToonExpo-Ecosystem/01-Modules/03-Buyer-Visitor-Area.md)
- [Builder Portal](./02-ToonExpo-Ecosystem/01-Modules/04-Builder-Portal.md)
- [Projects / Buildings / Floors / Apartments](./02-ToonExpo-Ecosystem/01-Modules/05-Projects-Buildings-Floors-Apartments.md)
- [Visual Map / Hotspots](./02-ToonExpo-Ecosystem/01-Modules/06-Visual-Map-Hotspots.md)
- [QR System](./02-ToonExpo-Ecosystem/01-Modules/07-QR-System.md)
- [CRM Lead Intake](./02-ToonExpo-Ecosystem/01-Modules/08-CRM-Lead-Intake.md)
...
- [Mortgage / Bank Offers](./02-ToonExpo-Ecosystem/01-Modules/16-Mortgage-Bank-Offers.md)
- [Service Provider Directory](./02-ToonExpo-Ecosystem/01-Modules/17-Service-Provider-Directory.md)
- [Coming Soon](./02-ToonExpo-Ecosystem/01-Modules/99-Coming-Soon.md)

## Roles / Data / UI

- [Roles](./02-ToonExpo-Ecosystem/02-Roles-And-Access/01-Roles.md)
- [Permissions Matrix](./02-ToonExpo-Ecosystem/02-Roles-And-Access/02-Permissions-Matrix.md)
- [Core Entities](./02-ToonExpo-Ecosystem/04-Data/01-Core-Entities.md)
- [Entity Model](./02-ToonExpo-Ecosystem/04-Data/02-Entity-Model.md)
- [Status Enums](./02-ToonExpo-Ecosystem/04-Data/03-Status-Enums.md)
- [Navigation](./02-ToonExpo-Ecosystem/03-UI-UX/01-Navigation.md)
...
This repo does not contain BOS implementation docs. Use only integration files when ToonExpo needs BOS context.
